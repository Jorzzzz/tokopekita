	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Tampara Kopi</a></h1>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli dan memesan <?php echo $itungtrans3 ?> barang di Tampara Kopi</span></h1>
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket">
					<h6>Total Harga yang harus dibayar saat ini</h6>
					<ul>
						<?php 
						$brg=mysqli_query($conn,"SELECT * from detailorder d, produk p where orderid='$orderidd' and d.idproduk=p.idproduk order by d.idproduk ASC");
						$no=1;
			...
			<img src="<?php echo $p['logo'] ?>" width="100px" height="50px"><br>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-5 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Tampara Kopi, Sorong.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:edhisusilo2901@gmail.com">edhisusilo2901@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>(+62) 822-4886-7905 (CEO)</li>
					</ul>
				</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2023 Tampara Kopi. All rights reserved</p>
			</div>
		</div>
